...
export function CreateItemContainer({ammo, armor}:{ammo:Boolean, armor:Boolean}) {
  ...
  return (
    ...
    <div className="flex flex-col text-center align-middle justify-center bg-[var(--primary-color)] min-h-[80px] w-full border-2 border-[var(--highlight-color)] border-l-[1px] border-b-[1px] sm:min-h-[80px]">
      ...
      <div className="bg-[var(--third-color)] flex flex-col gap-4 pt-[.5rem] pb-[1.5rem] pl-[.5rem] pr-[.5rem] overflow-y-auto max-h-[calc(100dvh-20.5rem)] min-h-[calc(100dvh-20.5rem)] sm:max-h-[calc(100dvh-10rem)] sm:min-h-[calc(100dvh-10rem)] border-2 border-[var(--highlight-color)] border-l-[1px] border-t-[1px]">
