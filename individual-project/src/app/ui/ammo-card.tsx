...
export function AmmoCard({ammoObj}:{ammoObj:incomingAmmo}) {
  ...
  return (
    <div className="bg-[var(--secondary-color)] min-h-[22rem] min-w-[17rem] text-black font-semibold relative text-md ammo-card sm:ammo-card-sm">
        ...
        <Image width="100" height="100" src={`/ammunition/${ammoObj.data.img}`} alt={`${ammoObj.name} image`}
          loading="lazy" className="object-scale-down w-full h-full z-[5]"/>
        </div>
